...
public class PlexiTextPanel extends Panel implements AdjustmentListener,
...
ActionListener {
	...
	public PlexiTextPanel() {
		tc = new PlexiTextCanvas(this);
	...
	/** Constructs a new TextPanel. */
	public PlexiTextPanel(String title) {
		this();
		this.title = title;
	}
	...
	*/
	...
	public void actionPerformed (ActionEvent e) {
		...
		System.out.println("PlexiTextPanel::cmd::"+cmd+"::");
		doCommand(cmd);
	}
	...
	*/
	...
	public void saveAs(String path) {
		if (path.equals("")) {
			PlexiSaveDialog sd = new PlexiSaveDialog("Save as Text", null, ".txt");
			String file = sd.getFileName();
			System.out.println("PlexiTextPanel::saveAs::"+file+"::");
			if (file == null) return;
