...
import java.awt.image.*;
import org.nrg.plexiviewer.lite.utils.PlexiIntHashtable;

public class PlexiGifEncoder extends ImageEncoder
    {
    ...
    public PlexiGifEncoder( Image img, OutputStream out ) throws IOException
	{
		super( img, out );
    ...
    public PlexiGifEncoder( Image img, OutputStream out, boolean interlace ) throws IOException
	{
		super( img, out );
    ...
    // @param out The stream to write the GIF to.
    public PlexiGifEncoder( ImageProducer prod, OutputStream out ) throws IOException
	{
		super( prod, out );
	}
    ...
    // @param prod The ImageProducer to encode.
    // @param out The stream to write the GIF to.
    public PlexiGifEncoder( ImageProducer prod, OutputStream out, boolean interlace ) throws IOException
	{
		super( prod, out );
		this.interlace = interlace;
	}
    ...
    void encodeDone() throws IOException
	{
		...
		int transparentRgb = -1;
	        ...
	        colorHash = new PlexiIntHashtable();
		int index = 0;
