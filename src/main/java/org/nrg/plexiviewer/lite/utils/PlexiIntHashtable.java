/*
 * org.nrg.plexiViewer.lite.utils.PlexiIntHashtable
...
public class PlexiIntHashtable extends Dictionary implements Cloneable
	{
	/// The hash table data.
	...
	public PlexiIntHashtable( int initialCapacity, float loadFactor )
	{
	...
	// capacity.
	// @param initialCapacity the initial number of buckets
	public PlexiIntHashtable( int initialCapacity )
	{
	...
	try
		{
		PlexiIntHashtable t = (PlexiIntHashtable) super.clone();
